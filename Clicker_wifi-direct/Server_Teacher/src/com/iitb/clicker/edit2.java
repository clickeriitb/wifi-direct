...
public class edit2 extends Activity implements OnClickListener, OnItemSelectedListener {
        ...
        try
        {
            ...
            bend.setOnClickListener(new OnClickListener() {
        		...
        		public void onClick(View v) {
        			...
        			Intent i=new Intent(edit2.this,page3.class);
        			startActivity(i);
