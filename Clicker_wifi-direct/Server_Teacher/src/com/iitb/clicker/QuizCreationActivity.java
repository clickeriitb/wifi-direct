...
public class QuizCreationActivity extends Activity implements OnClickListener, OnItemSelectedListener, OnCheckedChangeListener {
	SQLiteDatabase db;
	Button b,b2;
...
//		           Toast.makeText(getApplicationContext(), "SELECTED QUESTION!", Toast.LENGTH_LONG).show();
		           ...
		           else
		           {
		        	...
		        	e.printStackTrace();
	//	            Toast.makeText(QuizCreationActivity.this, "ERROR "+e.toString(), Toast.LENGTH_LONG).show();  
		    }
				}
		                     Intent i=new Intent(QuizCreationActivity.this,page3.class);
		         			startActivity(i);
			}
	...
	try
	{
			...
			if(spinner2.getItemAtPosition(spinner2.getSelectedItemPosition()).toString().equals("Arrange in correct order"))
			{
				 sql = "INSERT or replace INTO QUESTION ( CLASS, SUBJECT, QUESTION, TYPE_ID) VALUES('"+e14.getText().toString()+"','"+e3.getText().toString()+"','"+e4.getText().toString()+"','a');";       
           
			}
			else if(spinner2.getItemAtPosition(spinner2.getSelectedItemPosition()).toString().equals("Multiple choice, single correct answer"))
			{
				 sql = "INSERT or replace INTO QUESTION ( CLASS, SUBJECT, QUESTION, TYPE_ID) VALUES('"+e14.getText().toString()+"','"+e3.getText().toString()+"','"+e4.getText().toString()+"','s');";       
           
			}
			else if(spinner2.getItemAtPosition(spinner2.getSelectedItemPosition()).toString().equals("Multiple choice, multiple correct answer"))
			{
				 sql = "INSERT or replace INTO QUESTION ( CLASS, SUBJECT, QUESTION, TYPE_ID) VALUES('"+e14.getText().toString()+"','"+e3.getText().toString()+"','"+e4.getText().toString()+"','m');";       
           
			}
			else if(spinner2.getItemAtPosition(spinner2.getSelectedItemPosition()).toString().equals("True/False"))
			{
				
				 sql = "INSERT or replace INTO QUESTION ( CLASS, SUBJECT, QUESTION, TYPE_ID) VALUES('"+e14.getText().toString()+"','"+e3.getText().toString()+"','"+e4.getText().toString()+"','t');";       
				
			}	
			else if(spinner2.getItemAtPosition(spinner2.getSelectedItemPosition()).toString().equals("Yes/No"))
			{
				 sql = "INSERT or replace INTO QUESTION ( CLASS, SUBJECT, QUESTION, TYPE_ID) VALUES('"+e14.getText().toString()+"','"+e3.getText().toString()+"','"+e4.getText().toString()+"','y');";       
