...
public class edit extends Activity implements OnClickListener, OnItemSelectedListener {
...
Cursor cursor,cursor2;
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       // e111=(EditText)findViewById(R.id.EditText01);
 ...
 //       e13=(EditText)findViewById(R.id.EditText01);
        ...
        try
        {
            ...
            bend.setOnClickListener(new OnClickListener() {
        		...
        		public void onClick(View v) {
        			...
        			Intent i=new Intent(edit.this,import_from_quesbank.class);
        			startActivity(i);
            ...
            bnext.setOnClickListener(new OnClickListener() {
        		...
        		public void onClick(View v) {
    				...
    				j++;
    				if(j<import_from_quesbank.count)
    				{
    				//	Toast.makeText(edit.this, "moving to next", 1000).show();
    					
    					fun_cal();
    				}
    				else
    				{
    					//Toast.makeText(edit.this, "moving out", 1000).show();
    					Intent i=new Intent(edit.this,import_from_quesbank.class);
    					startActivity(i);
    				}
    				}
    ...
    void fun_cal()
    {
			...
			if(import_from_quesbank.b[j].isChecked())
			{
				flag=0;
				count=0;
				qid=import_from_quesbank.quesid[j];			
				try
	    		{
